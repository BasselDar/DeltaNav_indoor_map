...
export const graphData: GraphData = {
  vertices: [
    { id: "v1", objectName: null, cx: 361.105, cy: 512.811, type: 'path' },
    { id: "v2", objectName: null, cx: 237.691, cy: 512.811, type: 'path' },
    { 
      id: "v3", 
      objectName: "Zara", 
      cx: 237.691, 
      cy: 905.781, 
      type: 'store',
      description: 'Fashion retailer offering trendy clothing and accessories for men, women, and children',
    ...
    { 
      ...
      cy: 905.781,
      type: 'store',
      description: 'Electronics and gadget store with the latest tech accessories',
    ...
    { 
      ...
      cy: 905.781,
      type: 'store',
      description: 'Athletic footwear and sportswear retailer',
    ...
    { id: "v25", objectName: "Mall Office", cx: 195.932, cy: 439.536, type: 'service', description: 'Mall management office and customer service center', openingHours: '9:00 AM - 6:00 PM', contactInfo: '+1 (555) 0127', isAccessible: true },
    ...
    { id: "v34", objectName: "Entrance", cx: 1156.16, cy: 1014.082, type: 'entrance', description: 'Main mall entrance with automatic doors', isAccessible: true },
    ...
    { id: "v42", objectName: "North Wing Toilet", cx: 203.474, cy: 184.225, type: 'facility', description: 'Public restroom facilities with baby changing station', isAccessible: true },
    ...
    { id: "v72", objectName: "Starbucks", cx: 433.087, cy: 846.411, type: 'restaurant', description: 'Coffee shop offering premium beverages and light snacks', openingHours: '7:00 AM - 10:00 PM', contactInfo: '+1 (555) 0126', isAccessible: true },
